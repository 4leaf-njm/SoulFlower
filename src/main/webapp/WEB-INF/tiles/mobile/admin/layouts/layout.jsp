...
<link href="${pageContext.request.contextPath }/resources/css/mobile/commons.css?ver=${ver}" rel="stylesheet">
<link href="${pageContext.request.contextPath }/resources/css/mobile/admin.css?ver=${ver}" rel="stylesheet">
